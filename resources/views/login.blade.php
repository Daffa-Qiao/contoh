                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                        <div class="card card-plain">
                            <div class="card-header pb-0 text-start">
                                <h4 class="font-weight-bolder" style="color: green;">Sign In Patient</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <a href="/register" class="btn btn-lg w-100 mt-2 mb-0" 
                                        style="background-color:green; color: white;">
                                        Sign Up
                                    </a>
                                </div>
                    ...
                    <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
                        <div class="position-relative h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden" style="background-image: url('{{ asset('img/logo.png') }}'); background-size: cover;">
                            <span class="mask opacity-6" style="background-color:green;"></span>
                            <h4 class="mt-5 text-white font-weight-bolder position-relative">Sehat Rasa</h4>
