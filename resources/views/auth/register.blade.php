                            ...
                            <div class="card-body p-4">
                                <form role="form" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- Kecamatan -->
                                        <div class="col-12 mb-3">
                                            <label for="wilayah" class="form-label">Kecamatan</label>
                                            <select name="wilayah" class="form-control form-control-lg @error('subdistrict_id') is-invalid @enderror" required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <p class="mb-4 text-sm mx-auto">
                                                Sudah punya akun?
                                                <a href="/login" class="text-success">Masuk di sini</a>
                                            </p>
                                        </div>
